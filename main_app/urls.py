...
urlpatterns = [
    ...
    path('profiles/<int:profile_id>/assoc_country/<int:country_id>/', views.assoc_country, name='assoc_country'),
    path('profiles/<int:profile_id>/unassoc_country/<int:country_id>/', views.unassoc_country, name='unassoc_country'),
]
